package lab_final_cvr_sms_emc;

import java.util.Random;
import java.util.Scanner;
import javax.swing.JOptionPane;

public class Lab_Final_CVR_SMS_EMC {
                    ...
                    switch (opcionJuegos) {
                        case 1:
                            ...
                            JOptionPane.showMessageDialog(null,
                                    ...
                                    + "╠══════════════════════════════════════════════════════╣\n"
                                    + "║   ¡Bienvenido al sistema central de ciberseguridad!  \n"
                                    + "║                                                      \n"
                                    + "║  Dos analistas compiten por mantener la estabilidad  \n"
                                    + "║  del sistema mientras intentan contener brotes de    \n"
                                    + "║  virus dentro de 6 servidores digitales.             \n"
                                    + "║                                                      \n"
                                    + "║  • Cada jugador tiene una cantidad limitada de virus \n"
                                    + "║    que debe distribuir estratégicamente.             \n"
                                    + "║                                                      \n"
                                    + "║  • Un dado determina en cuál servidor se intentará   \n"
                                    + "║    colocar un virus cada turno.                      \n"
                                    + "║                                                      \n"
                                    + "║  • Si un servidor supera su capacidad… ¡COLAPSA! 💥   \n"
                                    + "║    Y los virus regresan al jugador.                  \n"
                                    + "║                                                      \n"
                                    + "║  • Gana quien logre vaciar antes todos sus virus.    \n"
                                    + "║                                                      \n"
                                    + "║     🧠 Estrategia, riesgo y suerte te esperan…        \n"
                                    + "╚══════════════════════════════════════════════════════╝");
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "╔══════════════════════════════════════════════════════╗\n"
                                    + "║           🔰  SISTEMA DESPEDIDO CON ÉXITO  🔰        \n"
                                    + "╠══════════════════════════════════════════════════════╣\n"
                                    + "║   Gracias por jugar *CONTENIENDO VIRUS* 🦠            \n"
                                    + "║                                                      \n"
                                    + "║   Tus decisiones como analista de seguridad han      \n"
                                    + "║   reforzado la integridad del sistema.               \n"
                                    + "║                                                      \n"
                                    + "║   Recuerda: un sistema protegido es un sistema vivo. \n"
